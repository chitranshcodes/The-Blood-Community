"""
Django settings for The_Blood_Community project.
...
ALLOWED_HOSTS = ['the-blood-community.onrender.com']
...
ROOT_URLCONF = 'The_Blood_Community.urls'
...
WSGI_APPLICATION = 'The_Blood_Community.wsgi.application'
